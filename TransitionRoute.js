...
var TransitionRoute = function (_React$Component) {
  ...
  function TransitionRoute(props, context) {
    ...
    _this.state = {
      match: match,
      inactive: _this.props.inactive | _this.context.router.inactive,
  ...
  _createClass(TransitionRoute, [{
    ...
    value: function render() {
      ...
      var alwaysProps = {
        ...
        history: history, staticContext: staticContext
      };

      return _react2.default.createElement(
        _reactTransitionGroup.CSSTransition,
        { "in": !!alwaysProps.rawMatch && !alwaysProps.inactive, timeout: this.props.timeout, classNames: this.props.classNames, unmountOnExit: true },
        function (state) {
          return (
            /* Render 'Always' part */
            component ? _react2.default.createElement(component, alwaysProps) : render ? render(alwaysProps) : null
          );
        }
      );
